...
values
  ...
  ('sp05', 'men', 15, 20, 7.5, 10, 7.5, 10, array['arsenal', 'premier_league']::text[]),
  ('rt-8889-home', 'men', 15, 20, 7.5, 10, 7.5, 10, array['arsenal', 'premier_league']::text[]),
  ('rt-7172-away', 'men', 15, 20, 7.5, 10, 7.5, 10, array['arsenal', 'premier_league']::text[]),
  ('rt-0304-home', 'men', 15, 20, 7.5, 10, 7.5, 10, array['arsenal', 'premier_league']::text[])
